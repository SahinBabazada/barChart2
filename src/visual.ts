...
//        d3.select(".yAxis2").selectAll("text").style("font-size", viewModel.YAxisFontSize);
        ...
        barSelectionMerged2
            ...
            .attr("height", (dataPoint: BarchartDataPoint) => dataPoint.actual < dataPoint.budget? (plotArea.height - yScale(Number(dataPoint.budget))): (plotArea.height - yScale(Number(dataPoint.actual))))
            .style("fill", (dataPoint: BarchartDataPoint) => '#83C5BE')
